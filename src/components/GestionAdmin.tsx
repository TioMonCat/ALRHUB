  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-[#111113] border border-stone-800 rounded-xl overflow-hidden shadow-lg">
                    ...
                    <tr key={u.uid} className="hover:bg-stone-900/10 font-sans">
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-3">
                          {u.photoURL ? (
                            <img src={u.photoURL} alt={u.displayName} className="w-8 h-8 rounded-full border border-stone-800" />
                          ) : (
