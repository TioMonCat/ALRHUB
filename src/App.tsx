  ...
  useEffect(() => {
    ...
    const unsubscribeSetups = onSnapshot(
      ...
      async (snapshot) => {
        ...
        if (snapshot.empty) {
          const hasSeeded = localStorage.getItem("alr_setups_seeded") === "true";
          if (!hasSeeded) {
            ...
            localStorage.setItem("alr_setups_seeded", "true");
            setSetups([seedLexus]);
        ...
        <AnimatePresence mode="wait">
          ...
          {firebaseUser && !isLoadingPortal && !isLoadingAuth && (firebaseUser.emailVerified || simulatedRole !== "real" || firebaseUser.email === "jaminecraft844@gmail.com") && (
            ...
            >
              ...
              {/* TAB: PILOT PROFILE */}
              {activeTab === "pilot_profile" && selectedPilotId && (
                <PilotProfile
                  pilot={allUsers.find(u => u.uid === selectedPilotId) || null}
